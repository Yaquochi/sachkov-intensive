export const intensivies = [
  {
    id: 0,
    name: "Архитектура .NET веб приложений",
    descr:
      "Архитектура .NET веб приложений Архитектура .NET веб приложений Архитектура .NET веб приложений Архитектура .NET веб приложений Архитектура .NET веб приложений",
    lessonsAmount: 15,
    duration: 13,
    programm: [
      {
        ...
        content: `<ul>
                        ...
                        <li class="programm-span">Начало проектирования конкретного проекта</li>
                        <li class="programm-span">Определяем функционал веб приложениям</li>
                        ...
                        <li class="programm-span">Определяем дальнейшие шаги проектирования</li>
                          </ul>`,
      },
      {
